...
export type WeaponItemsQueryVariables = Exact<{
  name?: InputMaybe<Scalars['String']['input']>;
}>;


export type WeaponItemsQuery = { __typename?: 'Query', items: Array<{ __typename?: 'Item', id: string, name?: string | null, normalizedName?: string | null, inspectImageLink?: string | null, image512pxLink?: string | null, properties?: { __typename?: 'ItemPropertiesAmmo' } | { __typename?: 'ItemPropertiesArmor' } | { __typename?: 'ItemPropertiesArmorAttachment' } | { __typename?: 'ItemPropertiesBackpack' } | { __typename?: 'ItemPropertiesBarrel' } | { __typename?: 'ItemPropertiesChestRig' } | { __typename?: 'ItemPropertiesContainer' } | { __typename?: 'ItemPropertiesFoodDrink' } | { __typename?: 'ItemPropertiesGlasses' } | { __typename?: 'ItemPropertiesGrenade' } | { __typename?: 'ItemPropertiesHeadphone' } | { __typename?: 'ItemPropertiesHeadwear' } | { __typename?: 'ItemPropertiesHelmet' } | { __typename?: 'ItemPropertiesKey' } | { __typename?: 'ItemPropertiesMagazine' } | { __typename?: 'ItemPropertiesMedKit' } | { __typename?: 'ItemPropertiesMedicalItem' } | { __typename?: 'ItemPropertiesMelee' } | { __typename?: 'ItemPropertiesNightVision' } | { __typename?: 'ItemPropertiesPainkiller' } | { __typename?: 'ItemPropertiesPreset' } | { __typename?: 'ItemPropertiesResource' } | { __typename?: 'ItemPropertiesScope' } | { __typename?: 'ItemPropertiesStim' } | { __typename?: 'ItemPropertiesSurgicalKit' } | { __typename?: 'ItemPropertiesWeapon', caliber?: string | null, fireRate?: number | null, ergonomics?: number | null, recoilVertical?: number | null, recoilDispersion?: number | null, convergence?: number | null, recoilAngle?: number | null, cameraRecoil?: number | null, cameraSnap?: number | null, centerOfImpact?: number | null, deviationCurve?: number | null, deviationMax?: number | null, defaultErgonomics?: number | null, defaultRecoilVertical?: number | null, defaultPreset?: { __typename?: 'Item', id: string, name?: string | null, inspectImageLink?: string | null, image512pxLink?: string | null, baseImageLink?: string | null } | null } | { __typename?: 'ItemPropertiesWeaponMod' } | null } | null> };

export type SingleWeaponQueryVariables = Exact<{
  normalizedName: Scalars['String']['input'];
}>;


export type SingleWeaponQuery = { __typename?: 'Query', item?: { __typename?: 'Item', id: string, normalizedName?: string | null, shortName?: string | null, description?: string | null, category?: { __typename?: 'ItemCategory', name: string } | null, properties?: { __typename?: 'ItemPropertiesAmmo' } | { __typename?: 'ItemPropertiesArmor' } | { __typename?: 'ItemPropertiesArmorAttachment' } | { __typename?: 'ItemPropertiesBackpack' } | { __typename?: 'ItemPropertiesBarrel' } | { __typename?: 'ItemPropertiesChestRig' } | { __typename?: 'ItemPropertiesContainer' } | { __typename?: 'ItemPropertiesFoodDrink' } | { __typename?: 'ItemPropertiesGlasses' } | { __typename?: 'ItemPropertiesGrenade' } | { __typename?: 'ItemPropertiesHeadphone' } | { __typename?: 'ItemPropertiesHeadwear' } | { __typename?: 'ItemPropertiesHelmet' } | { __typename?: 'ItemPropertiesKey' } | { __typename?: 'ItemPropertiesMagazine' } | { __typename?: 'ItemPropertiesMedKit' } | { __typename?: 'ItemPropertiesMedicalItem' } | { __typename?: 'ItemPropertiesMelee' } | { __typename?: 'ItemPropertiesNightVision' } | { __typename?: 'ItemPropertiesPainkiller' } | { __typename?: 'ItemPropertiesPreset' } | { __typename?: 'ItemPropertiesResource' } | { __typename?: 'ItemPropertiesScope' } | { __typename?: 'ItemPropertiesStim' } | { __typename?: 'ItemPropertiesSurgicalKit' } | { __typename?: 'ItemPropertiesWeapon', defaultPreset?: { __typename?: 'Item', id: string, name?: string | null, inspectImageLink?: string | null, image512pxLink?: string | null, baseImageLink?: string | null } | null } | { __typename?: 'ItemPropertiesWeaponMod' } | null } | null };



export const WeaponItemsDocument = `
...
export const useWeaponItemsQuery = <
      TData = WeaponItemsQuery,
      TError = unknown
    >(
      variables?: WeaponItemsQueryVariables,
      options?: Omit<UseQueryOptions<WeaponItemsQuery, TError, TData>, 'queryKey'> & { queryKey?: UseQueryOptions<WeaponItemsQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useQuery<WeaponItemsQuery, TError, TData>(
      {
    queryKey: variables === undefined ? ['WeaponItems'] : ['WeaponItems', variables],
    queryFn: fetcher<WeaponItemsQuery, WeaponItemsQueryVariables>(WeaponItemsDocument, variables),
    ...options
  }
    )};

useWeaponItemsQuery.getKey = (variables?: WeaponItemsQueryVariables) => variables === undefined ? ['WeaponItems'] : ['WeaponItems', variables];

export const useSuspenseWeaponItemsQuery = <
      TData = WeaponItemsQuery,
      TError = unknown
    >(
      variables?: WeaponItemsQueryVariables,
      options?: Omit<UseSuspenseQueryOptions<WeaponItemsQuery, TError, TData>, 'queryKey'> & { queryKey?: UseSuspenseQueryOptions<WeaponItemsQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useSuspenseQuery<WeaponItemsQuery, TError, TData>(
      {
    queryKey: variables === undefined ? ['WeaponItemsSuspense'] : ['WeaponItemsSuspense', variables],
    queryFn: fetcher<WeaponItemsQuery, WeaponItemsQueryVariables>(WeaponItemsDocument, variables),
    ...options
  }
    )};

useSuspenseWeaponItemsQuery.getKey = (variables?: WeaponItemsQueryVariables) => variables === undefined ? ['WeaponItemsSuspense'] : ['WeaponItemsSuspense', variables];


useWeaponItemsQuery.fetcher = (variables?: WeaponItemsQueryVariables, options?: RequestInit['headers']) => fetcher<WeaponItemsQuery, WeaponItemsQueryVariables>(WeaponItemsDocument, variables, options);

export const SingleWeaponDocument = `
...
export const useSingleWeaponQuery = <
      TData = SingleWeaponQuery,
      TError = unknown
    >(
      variables: SingleWeaponQueryVariables,
      options?: Omit<UseQueryOptions<SingleWeaponQuery, TError, TData>, 'queryKey'> & { queryKey?: UseQueryOptions<SingleWeaponQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useQuery<SingleWeaponQuery, TError, TData>(
      {
    queryKey: ['SingleWeapon', variables],
    queryFn: fetcher<SingleWeaponQuery, SingleWeaponQueryVariables>(SingleWeaponDocument, variables),
    ...options
  }
    )};

useSingleWeaponQuery.getKey = (variables: SingleWeaponQueryVariables) => ['SingleWeapon', variables];

export const useSuspenseSingleWeaponQuery = <
      TData = SingleWeaponQuery,
      TError = unknown
    >(
      variables: SingleWeaponQueryVariables,
      options?: Omit<UseSuspenseQueryOptions<SingleWeaponQuery, TError, TData>, 'queryKey'> & { queryKey?: UseSuspenseQueryOptions<SingleWeaponQuery, TError, TData>['queryKey'] }
    ) => {
    
    return useSuspenseQuery<SingleWeaponQuery, TError, TData>(
      {
    queryKey: ['SingleWeaponSuspense', variables],
    queryFn: fetcher<SingleWeaponQuery, SingleWeaponQueryVariables>(SingleWeaponDocument, variables),
    ...options
  }
    )};

useSuspenseSingleWeaponQuery.getKey = (variables: SingleWeaponQueryVariables) => ['SingleWeaponSuspense', variables];


useSingleWeaponQuery.fetcher = (variables: SingleWeaponQueryVariables, options?: RequestInit['headers']) => fetcher<SingleWeaponQuery, SingleWeaponQueryVariables>(SingleWeaponDocument, variables, options);
